                ...
                <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                  ...
                  {isLoggedIn ? (
                    <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                      ...
                      <Link
                        href="/qna/ask_question"
                        className="ml-3 inline-flex items-center rounded-md border border-transparent bg-rose-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2"
                      >
                        Ask Question
                      </Link>
                      <Link
